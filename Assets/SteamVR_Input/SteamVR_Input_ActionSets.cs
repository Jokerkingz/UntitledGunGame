...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Actions
    {
        ...
        private static SteamVR_Input_ActionSet_UpgradeInput p_UpgradeInput;
        ...
        public static SteamVR_Input_ActionSet_UpgradeInput UpgradeInput
        {
            get
            {
                return SteamVR_Actions.p_UpgradeInput.GetCopy<SteamVR_Input_ActionSet_UpgradeInput>();
            }
        }
        ...
        private static void StartPreInitActionSets()
        {
            ...
            SteamVR_Actions.p_UpgradeInput = ((SteamVR_Input_ActionSet_UpgradeInput)(SteamVR_ActionSet.Create<SteamVR_Input_ActionSet_UpgradeInput>("/actions/UpgradeInput")));
            Valve.VR.SteamVR_Input.actionSets = new Valve.VR.SteamVR_ActionSet[] {
                    SteamVR_Actions._default,
                    SteamVR_Actions.platformer,
                    SteamVR_Actions.buggy,
                    SteamVR_Actions.mixedreality,
                    SteamVR_Actions.UpgradeInput};
        }
    }
}
